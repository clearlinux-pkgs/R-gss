...
Version  : 2.1.12
Release  : 21
URL      : https://cran.r-project.org/src/contrib/gss_2.1-12.tar.gz
Source0  : https://cran.r-project.org/src/contrib/gss_2.1-12.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1583165445
